...
A <- data[data$name == "C5A_R1_m10_i17_2021",]
str(A)
B <- data[data$name == "C5A_R1_lsurf_i15_2021",]
C <- data[data$name == "C5A_R1_m0surf_i16_2021",]
D <- data[data$name == "C5A_R3_m01surf_i24_2021",]
woodpile <- c(A,B,C,D)
