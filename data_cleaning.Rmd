...
data.cut1 <- data.cut1[-(data.cut1$name == "C5A_R1_m10_i17" | data.cut1$name == "C5A_R1_lsurf_i15_2021" | 
                           data.cut1$name == "C5A_m0surf_i16_2021" | data.cut1$name == "C5A_R3_m01surf_i24_2021"),]
