...
setwd("C:/Users/sbaue/coding/Itasca_project_19-20")
```
...
changed location name to 2021_ibuttons_copy_B2

```{r }


m <- list.files("./2021_ibuttons_copy_B2/", pattern = "*.csv")
m

file_df <- data.frame(paths = m, name = str_replace(m, ".csv",""), full_paths = list.files("./2021_ibuttons_copy_B2/", pattern = "*.csv", full.names = TRUE))
...
create_csv("./2021_ibuttons_copy_B2/i11_3E00000069B0E841_083020.csv", "i11")
